...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index2.html" class="logo">
            ...
            <span class="logo-mini"><b>EÖ</b></span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>EÖ </b>CMS</span>
        </a>
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2021 <a href="#">EÖ YAZILIM</a>.</strong> All rights reserved.
    </footer>
